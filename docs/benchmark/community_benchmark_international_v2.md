...
| Distance gap (%) | `(ours_distance - baseline_distance) / baseline_distance × 100` |
| Gap to BKS (%) | `(ours_distance - BKS_distance) / BKS_distance × 100` |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| Li–Lim | large | 104 | 100.000 | 0.087 | 2.076 | 56.171 | 0 |
| Li–Lim | medium | 177 | 100.000 | 0.057 | 1.409 | 53.388 | 0 |
| Li–Lim | small | 73 | 80.822 | 0.119 | 1.661 | 45.022 | 0 |
| Solomon-style | small | 6 | 100.000 | -1.833 | 3.580 | 60.580 | 0 |
