...
$summary=[ordered]@{version="v1.0.2-benchmark-suite-certification"; startedAt=(Get-Date).ToString("o")}
try {
  ...
  $summary.overallPass=($summary.compileJava -eq "PASS" -and $summary.solverRuntime -eq "PASS" -and $summary.allInOneSmoke -eq "PASS" -and $summary.compareSuite -eq "PASS" -and $summary.dominanceFailures -eq 0)
