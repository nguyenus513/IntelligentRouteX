...
def build_quality(certification_root: Path) -> Dict[str, Any]:
    ...
    return {"schemaVersion": "food-dispatch-quality/v1", "benchmarkFamily": "grubhub-mdrplib-quality-thresholds", "sourceCertification": str(certification_path), "rowCount": len(rows), "finalVerdict": final, "layers": layers}
